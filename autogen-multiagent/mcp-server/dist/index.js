...
var log = (level, message, meta) => {
  appendFileSync(join(import.meta.dir, "../server.log"), formatMessage(level, message, meta));
};
var debug = (message, meta) => log("DEBUG", message, meta);
var info = (message, meta) => log("INFO", message, meta);
var warn = (message, meta) => log("WARN", message, meta);
var error = (message, meta) => log("ERROR", message, meta);
var fatal = (message, meta) => log("FATAL", message, meta);
var logger_default = { debug, info, warn, error, fatal };
...
var ParamsArgsSchema = z.object({
  a: z.number().describe("First number"),
  b: z.number().describe("Second number")
});
var TableNameArgsSchema = z.object({
    ...
    tools: [
      {
        ...
        inputSchema: zodToJsonSchema(ParamsArgsSchema)
      },
      {
        name: "subtract",
      ...
      },
      {
        ...
        inputSchema: zodToJsonSchema(TableNameArgsSchema)
      }
    ]
  };
});
var MockGetTableSchema = (tableName) => {
  if (!tableName) {
...
async function startServer() {
  logger_default.info("Initializing server...");
  const transport = new StdioServerTransport;
  try {
    logger_default.info("Connecting to transport...");
    await server.connect(transport);
    logger_default.info("Server started successfully");
  } catch (err) {
    logger_default.fatal("Failed to start server", {
